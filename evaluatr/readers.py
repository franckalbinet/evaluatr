"""This module provides a unified interface for loading evaluation data from organizational repositories (IOM, UNHCR, etc.) and transforming it into standardized JSON format.a"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_readers.ipynb.

# %% auto 0
__all__ = ['default_config', 'EvalReader', 'iom_input_cfg', 'Evaluation', 'IOMRepoReader', 'load_evals']
