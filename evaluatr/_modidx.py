...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'evaluatr'},
  'syms': { 'evaluatr.db_traces': { 'evaluatr.db_traces.Trace': ('db_traces.html#trace', 'evaluatr/db_traces.py'),
                                    'evaluatr.db_traces.TraceDB': ('db_traces.html#tracedb', 'evaluatr/db_traces.py'),
                                    'evaluatr.db_traces.TraceDB.__init__': ('db_traces.html#tracedb.__init__', 'evaluatr/db_traces.py'),
                                    'evaluatr.db_traces.TraceDB.delete_stage_traces': ( 'db_traces.html#tracedb.delete_stage_traces',
                                                                                        'evaluatr/db_traces.py')},
